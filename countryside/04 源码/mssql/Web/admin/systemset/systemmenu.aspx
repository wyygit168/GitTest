<%@ Page Language="C#" AutoEventWireup="true" CodeFile="systemmenu.aspx.cs" Inherits="admin_systemset_systemmenu" EnableViewState="false" %>
            ...
            <td class="PageTableTd" >
                ...
                <tr>
                    ...
                    <div class="PageContent">
                     <div class="PageTitleBar"><div class="PageTitleName">【系统资源】列表</div></div>
                       ...
                       <div class="PageCenterContent" >
                            ...
                            <table class="searchTable"  >
                                 ...
                                 <tbody>
                                     <tr>
                                      ...
                                      <td class="headRight">资源名称</td>
                                      <td><asp:TextBox ID="txtTitle" runat="server" CssClass="textbox" Width="95%" MaxLength="50"   ></asp:TextBox></td>
                                      <td class="headRight">资源URL</td>
                                      <td><asp:TextBox ID="txtMenuUrl" runat="server" CssClass="textbox" Width="95%"   MaxLength="50"   ></asp:TextBox></td>
                                      ...
                                      <tr>
                                      <td class="headRight">所属顶级菜单</td>
                                      <td><asp:DropDownList ID="ddlTopMenuID"   runat="server"   Width="95%" > </asp:DropDownList></td> 
                                      <td class="headRight">所属一级菜单</td>
                                      <td style="border-right:0px"><asp:DropDownList ID="ddlOneMenu"   runat="server"   Width="95%"> 
                            ...
                            <div id="divbtn" runat="server" style="margin-top: 6px; margin-bottom: 6px">
                                 <input class="buttonTwo" id="btnAdd" onclick="newoperation('systemmenudetail.aspx?action=new',900,450,'【系统资源】：新增')" type="button" value="新 增 " runat="server" />
