<%@ Page Language="C#" AutoEventWireup="true" CodeFile="systemcustomer.aspx.cs" Inherits="admin_systemset_systemcustomer" %>
            ...
            <td class="PageTableTd" >
                ...
                <tr>
                    ...
                    <div class="PageContent">
                     <div class="PageTitleBar"><div class="PageTitleName">【客户设置】列表</div></div>
                         ...
                         <table class="searchTable">
                                 ...
                                 <tbody>
                                     <tr>
                                      ...
                                      <td class="headRight">联系人</td>
                                      <td><asp:TextBox ID="txtUserName" runat="server" CssClass="textbox" Width="95%" MaxLength="50"   ></asp:TextBox></td>
                                      <td class="headRight">客户状态</td>
                                      <td><asp:DropDownList ID="ddlStatus"   runat="server"   Width="95%" >
                                          <asp:ListItem Value="">请选择</asp:ListItem>
                                          <asp:ListItem Value="1">有效</asp:ListItem>
                                          <asp:ListItem Value="0">无效</asp:ListItem>
                                          </asp:DropDownList></td>
                                          <td class="headRight">权限状态</td>
                                      <td><asp:DropDownList ID="drpPurviewStatus"   runat="server"   Width="95%" >
                                          <asp:ListItem Value="">请选择</asp:ListItem>
                                          <asp:ListItem Value="1">权限开通</asp:ListItem>
                                          <asp:ListItem Value="0">权限关闭</asp:ListItem>
                                          </asp:DropDownList></td>
                             ...
                             <div style="margin-top: 6px; margin-bottom: 6px">
                                 <input class="buttonTwo" id="btnAdd" onclick="newoperation('systemcustomerdetail.aspx?action=new',900,450,'【系统客户】：新增')" type="button" value="新 增 " runat="server" />
