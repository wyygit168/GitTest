...
public partial class admin_systemset_systemcustomer : SystemMainBasePage
{
    ...
    private void DisplayData()
    {
        ...
        ajaxEntity.Extend1 = CommonMethod.ClearInputText(txtUserName.Text, 50);
    ...
    private void LoadScript()
    {
        ...
        sb.AppendFormat("<script type=\"text/javascript\" src=\"{0}\"></script>", CurrentDomainRootPath + "scripts/admin/systemset/systemcustomer.aspx.js?v=" + CommonMethod.Version);
