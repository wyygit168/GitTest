...
using BLL.Service;
public partial class admin_systemset_areaprovinceset : SystemMainBasePage
{
    ...
    private void LoadScript()
    {
        ...
        sb.AppendFormat("<script type=\"text/javascript\" src=\"{0}\"></script>", CurrentDomainRootPath + "scripts/admin/systemset/areaprovinceset.aspx.js?v=" + CommonMethod.Version);
