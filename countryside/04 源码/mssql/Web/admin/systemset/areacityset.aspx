<%@ Page Language="C#" AutoEventWireup="true" CodeFile="areacityset.aspx.cs" Inherits="admin_systemset_areacityset" %>
            ...
            <td class="PageTableTd" >
                ...
                <tr>
                    ...
                    <div class="PageContent">
                     <div class="PageTitleBar"><div class="PageTitleName">【城市设置】列表</div></div>
                       ...
                       <div class="PageCenterContent" >
                         <table class="searchTable">
                             ...
                             <div style="margin-top: 6px; margin-bottom: 6px">
                                 <input class="buttonTwo" id="btnAdd" onclick="newoperation('areacitysetdetail.aspx?action=new',900,450,'【城市设置】：新增')" type="button" value="新 增 " runat="server"  />
