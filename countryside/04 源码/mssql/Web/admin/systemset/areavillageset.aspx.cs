...
public partial class admin_systemset_areavillageset : SystemMainBasePage
{
    ...
    private void DisplayData()
    {
        ...
        ajaxEntity.Extend4 = ddlCountyID.SelectedValue;
        ajaxEntity.Extend5 = ddlTownID.SelectedValue;
    ...
    private void LoadScript()
    {
        ...
        sb.AppendFormat("<script type=\"text/javascript\" src=\"{0}\"></script>", CurrentDomainRootPath + "scripts/admin/systemset/areavillageset.aspx.js?v=" + CommonMethod.Version);
