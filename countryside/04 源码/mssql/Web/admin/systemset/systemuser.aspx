    <%@ Page Language="C#" AutoEventWireup="true" CodeFile="systemuser.aspx.cs" Inherits="admin_systemset_systemuser"  EnableViewState="false"  %>
            ...
            <td class="PageTableTd" >
                ...
                <tr>
                    ...
                    <div class="PageContent">
                     <div class="PageTitleBar"><div class="PageTitleName">【系统用户】列表</div></div>
                       ...
                       <div class="PageCenterContent" >
                         <table class="searchTable">
                             ...
                             <div style="margin-top: 6px; margin-bottom: 6px">
                                 <input class="buttonTwo" id="btnAdd" onclick="newoperation('systemuserdetail.aspx?action=new',900,450,'【系统角色】：新增')" type="button" value="新 增 " runat="server" />
