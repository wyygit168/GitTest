...
using BLL.Service;
public partial class admin_systemset_systemrole : SystemMainBasePage
{
    #region Page_Load
    ...
    private void LoadScript()
    {
        ...
        sb.AppendFormat("<script type=\"text/javascript\" src=\"{0}\"></script>", CurrentDomainRootPath + "scripts/admin/systemset/systemrole.aspx.js?v=" + CommonMethod.Version);
