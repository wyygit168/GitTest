...
public partial class admin_systemset_areatownset : SystemMainBasePage
{
    #region Page_Load
    ...
    private void LoadScript()
    {
        ...
        sb.AppendFormat("<script type=\"text/javascript\" src=\"{0}\"></script>", CurrentDomainRootPath + "scripts/admin/systemset/areatownset.aspx.js?v=" + CommonMethod.Version);
