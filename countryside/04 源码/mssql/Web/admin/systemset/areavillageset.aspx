<%@ Page Language="C#" AutoEventWireup="true" CodeFile="areavillageset.aspx.cs" Inherits="admin_systemset_areavillageset" %>
            ...
            <td class="PageTableTd" >
                ...
                <tr>
                    ...
                    <div class="PageContent">
                     <div class="PageTitleBar"><div class="PageTitleName">【乡村设置】列表</div></div>
                       ...
                       <div class="PageCenterContent" >
                         <table class="searchTable">
                                 ...
                                 <tbody>
                                     ...
                                     <td class="headRight">所属城市</td>
                                      ...
                                      <td><asp:DropDownList ID="ddlCountyID"   runat="server"   Width="95%" >
                                          ...
                                          <td class="headRight">所属乡镇</td>
                                      <td><asp:DropDownList ID="ddlTownID"   runat="server"   Width="95%" >
                                           <asp:ListItem Value="">请选择</asp:ListItem>
                                          </asp:DropDownList></td>
                             ...
                             <div style="margin-top: 6px; margin-bottom: 6px">
                                 <input class="buttonTwo" id="btnAdd" onclick="newoperation('areavillagesetdetail.aspx?action=new',900,450,'【乡村设置】：新增')" type="button" value="新 增 " runat="server"  />
