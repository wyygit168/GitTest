...
using System.Text;
using BLL.Service;
public partial class admin_systemset_systemdomainbind : SystemMainBasePage
{
    ...
    private void DisplayData()
    {
        ...
        ajaxEntity.Title = CommonMethod.ClearInputText(txtCustomerTitle.Text, 50);
        ajaxEntity.Extend1 = CommonMethod.ClearInputText(txtDomainTitle.Text, 50);
    ...
    private void LoadScript()
    {
        ...
        sb.AppendFormat("<script type=\"text/javascript\" src=\"{0}\"></script>", CurrentDomainRootPath + "scripts/admin/systemset/systemdomainbind.aspx.js?v=" + CommonMethod.Version);
