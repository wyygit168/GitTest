<%@ Page Language="C#" AutoEventWireup="true" CodeFile="systemdomain.aspx.cs" Inherits="admin_systemset_systemdomain" %>
            ...
            <td class="PageTableTd" >
                ...
                <tr>
                    ...
                    <div class="PageContent">
                     <div class="PageTitleBar"><div class="PageTitleName">【域名设置】列表</div></div>
                       ...
                       <div class="PageCenterContent" >
                         <table class="searchTable">
                             ...
                             <div style="margin-top: 6px; margin-bottom: 6px">
                                 <input class="buttonTwo" id="btnAdd" onclick="newoperation('systemdomaindetail.aspx?action=new',600,280,'【系统域名】：新增')" type="button" value="新 增 " runat="server" />
