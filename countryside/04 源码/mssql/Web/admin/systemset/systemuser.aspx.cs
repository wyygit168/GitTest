...
public partial class admin_systemset_systemuser  : SystemMainBasePage
{
    ...
    private void LoadScript()
    {
        ...
        sb.AppendFormat("<script type=\"text/javascript\" src=\"{0}\"></script>", CurrentDomainRootPath + "scripts/admin/systemset/systemuser.aspx.js?v=" + CommonMethod.Version);
