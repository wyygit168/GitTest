...
public partial class admin_systemset_areacityset : SystemMainBasePage
{
    ...
    private void LoadScript()
    {
        ...
        sb.AppendFormat("<script type=\"text/javascript\" src=\"{0}\"></script>", CurrentDomainRootPath + "scripts/admin/systemset/areacityset.aspx.js?v=" + CommonMethod.Version);
