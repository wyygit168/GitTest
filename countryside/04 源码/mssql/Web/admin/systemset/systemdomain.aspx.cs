...
public partial class admin_systemset_systemdomain : SystemMainBasePage
{
    ...
    private void LoadScript()
    {
        ...
        sb.AppendFormat("<script type=\"text/javascript\" src=\"{0}\"></script>", CurrentDomainRootPath + "scripts/admin/systemset/systemdomain.aspx.js?v=" + CommonMethod.Version);
