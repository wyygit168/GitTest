...
public partial class admin_webset_webmenuset : SystemMainBasePage
{
    ...
    private void LoadScript()
    {
        ...
        sb.AppendFormat("<script type=\"text/javascript\" src=\"{0}\"></script>", CurrentDomainRootPath + "scripts/admin/webset/webmenuset.aspx.js?v=" + CommonMethod.Version);
