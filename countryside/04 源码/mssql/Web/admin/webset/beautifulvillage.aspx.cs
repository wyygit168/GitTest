...
using BLL.Service;
using System.Text;
public partial class admin_webset_beautifulvillage : SystemMainBasePage
{
    ...
    private void DisplayData()
    {
        ...
        ajaxEntity.Extend3 = ddlVillageID.SelectedValue;
    ...
    private void LoadScript()
    {
        ...
        sb.AppendFormat("<script type=\"text/javascript\" src=\"{0}\"></script>", CurrentDomainRootPath + "scripts/admin/webset/beautifulvillage.aspx.js?v=" + CommonMethod.Version);
