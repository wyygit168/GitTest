<%@ Page Language="C#" AutoEventWireup="true" CodeFile="beautifulvillagedetail.aspx.cs" Inherits="admin_webset_beautifulvillagedetail" %>
...
<body>
      ...
      <%--乡村概述--%>
      <div id="divOverView" runat="server">
       <table style="margin: 2px 0 0 8px; width:98% " class="tblInfor">
                ...
                <tr>
                 ...
                 <tr id="trVillageID"   runat="server" >
                   ...
                   <tr>
                  <td  class="rhead" > 村庄介绍： </td>
                    <td colspan="3"> <CKEditor:CKEditorControl ID="txtIntro" Width="98%" Height="151" BasePath="~/ckeditor" runat="server">
                    </CKEditor:CKEditorControl>
                    
                    </td>
                </tr>
                <tr>
                  <td  class="rhead" > 生产美： </td>
                    <td colspan="3"> <CKEditor:CKEditorControl ID="txtYield" Width="98%" Height="151" BasePath="~/ckeditor" runat="server">
                    </CKEditor:CKEditorControl>
                    
                    </td>
                </tr>
                <tr>
                  <td  class="rhead" > 生活美： </td>
                    <td colspan="3"> <CKEditor:CKEditorControl ID="txtLive" Width="98%" Height="151" BasePath="~/ckeditor" runat="server">
                    </CKEditor:CKEditorControl>
                    
                    </td>
                </tr> 
                <tr>
                  <td  class="rhead" > 环境美： </td>
                    <td colspan="3"> <CKEditor:CKEditorControl ID="txtEnvironment" Width="98%" Height="151" BasePath="~/ckeditor" runat="server">
                    </CKEditor:CKEditorControl>
                    
                    </td>
                </tr> <tr>
                  <td  class="rhead" > 人文美： </td>
                    <td colspan="3"> <CKEditor:CKEditorControl ID="txtHumanism" Width="98%" Height="151" BasePath="~/ckeditor" runat="server">
                    </CKEditor:CKEditorControl>
      ...
      <div  id="divImage" runat="server" visible="false" > 
         <table  class="tblInfor" width="98%">
               <colgroup>
                    ...
                    <tr>
                   <td  class="rhead" > 所属乡村： </td>
                    <td  class="brnull"><asp:DropDownList ID="drpImgVillage" CssClass="textbox" runat="server" Width="183px" Height="25">
                         </asp:DropDownList>
                     </td>
                      <td class="blnull">
                        <span class="onshow" id="spandrpimgvillage"  >必填项！</span>
                         </td> 
                 </tr>
                    <%--<tr >
                        <td class="rhead">链接地址：</td>
                        <td  >
                            <asp:TextBox runat="server" ID="txtImageLinkUrl" Width="250"  CssClass="textbox" Text="" MaxLength="200"></asp:TextBox></td>
                    </tr>--%>
                    <tr>
                        <td class="rhead">
                            选项：</td>
                     ...
                     <tr runat="server" id="trImageView"  visible="false" >
                        <td class="rhead">
                            图片预览：</td>
                        <td colspan="2">
                            <a id="aimage" runat="server"><asp:Image ID="imgView" runat="server" Width="380" Height="300" /></a>
                        </td>
                    </tr>
                    <tr>
       ...
       <table style="margin: 2px 0 0 8px; width:98%; display:none;" class="tblInfor">
                ...
                <tr>
                 ...
                 <tr id="tr1"   runat="server" >
                   <td  class="rhead" > 所属乡村： </td>
                    <td colspan="3" ><asp:DropDownList ID="DropDownList1" CssClass="textbox" runat="server" Width="183px" Height="25">
                         </asp:DropDownList>
                     </td>
                 </tr>
                   <tr>
