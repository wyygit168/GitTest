...
public partial class admin_webset_farmingnews : SystemMainBasePage
{
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        if (!IsPostBack)
        {
            ...
            #endregion
            LoadScript();
            UtilitySearch.LoadVillage(ddlVillage, CurrentUser.TownID, "请选择乡村");
            DisplayData();
        }
    }
    #endregion
    ...
    private void LoadScript()
    {
        ...
        sb.AppendFormat("<script type=\"text/javascript\" src=\"{0}\"></script>", CurrentDomainRootPath + "scripts/admin/webset/farmingnews.aspx.js?v=" + CommonMethod.Version);
