<%@ Page Language="C#" AutoEventWireup="true" CodeFile="webmenuset.aspx.cs" Inherits="admin_webset_webmenuset" %>
            ...
            <td class="PageTableTd" >
                ...
                <tr>
                    ...
                    <div class="PageContent">
                     <div class="PageTitleBar"><div class="PageTitleName">【菜单设置】列表</div></div>
                       ...
                       <div class="PageCenterContent" >
                         <table class="searchTable">
                                 ...
                                 <tbody>
                                     <tr>
                                      ...
                                      <td><asp:DropDownList ID="ddlStatus"   runat="server"   Width="95%" >
                                        ...
                                        <td class="headRight">启用状态</td>
                                      <td><asp:DropDownList ID="ddlEnable"   runat="server"   Width="95%" >
                                          <asp:ListItem Value="">请选择</asp:ListItem>
                                          <asp:ListItem Value="1">有效</asp:ListItem>
                                          <asp:ListItem Value="0">无效</asp:ListItem>
                                          </asp:DropDownList>
                             ...
                             <div style="margin-top: 6px; margin-bottom: 6px">
                                 <input class="buttonTwo" id="btnAdd" onclick="newoperation('webmenusetdetail.aspx?action=new',900,450,'【网站菜单】：新增')" type="button" value="新 增 " runat="server" />
