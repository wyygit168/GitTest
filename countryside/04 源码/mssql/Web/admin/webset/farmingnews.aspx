<%@ Page Language="C#" AutoEventWireup="true" CodeFile="farmingnews.aspx.cs" Inherits="admin_webset_farmingnews" %>
            ...
            <td class="PageTableTd" >
                ...
                <tr>
                    ...
                    <div class="PageContent">
                     <div class="PageTitleBar"><div class="PageTitleName">【资讯速递】列表</div></div>
                                 ...
                                 <tbody>
                                     <tr>
                                      ...
                                      <td><asp:TextBox ID="txtTitle" runat="server" CssClass="textbox" Width="95%" MaxLength="50"   ></asp:TextBox></td>
                                        <td class="headRight">资讯类型</td>
                                      <td><asp:DropDownList ID="ddlOpertype"   runat="server"   Width="95%" >
                                          <asp:ListItem Value="">请选择</asp:ListItem>
                                          <asp:ListItem Value="2">最新公告</asp:ListItem>
                                          <asp:ListItem Value="1">地方资讯</asp:ListItem>
                                          <asp:ListItem Value="0">法律法规</asp:ListItem>
                                          </asp:DropDownList></td> 
                                       <td class="headRight">所属乡村</td> 
                                      <td><asp:DropDownList ID="ddlVillage"   runat="server"   Width="95%" > </asp:DropDownList></td> 
