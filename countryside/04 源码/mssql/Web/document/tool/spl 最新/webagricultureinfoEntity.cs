...
// -------------------------------------------------------------
//             Created By： thinkpad
//             Created Time： 2014/11/20 22:31:23
// -------------------------------------------------------------
namespace BusinessEntity
{
    ...
    /// <summary>
    /// 实体webagricultureinfoEntity，对应表webagricultureinfo
    /// </summary>
    [Serializable()]
    public sealed class webagricultureinfoEntity : EntityObject
    {
        ...
        /// 默认构造函数
        /// </summary>
        public webagricultureinfoEntity()
        {
        }
        ...
        /// </summary>
        public static webagricultureinfoEntity GetEntityByPrimaryKey(int AutoId)
        {
            webagricultureinfoEntity obj = new webagricultureinfoEntity();
            obj.AutoId=AutoId;
            obj.Retrieve();
            if (obj.IsPersistent)
            {
        ...
        {
            if ((obj == null) || !(obj is webagricultureinfoEntity))
            {
                return false;
            }
            webagricultureinfoEntity tmpObj = (webagricultureinfoEntity)obj;
