...
namespace BusinessEntity
{
    ...
    /// <summary>
    /// 实体systemdomainEntity，对应表systemdomain
    /// </summary>
    [Serializable()]
    public sealed class systemdomainEntity : EntityObject
    {
        ...
        /// </summary>
        public static systemdomainEntity GetEntityByPrimaryKey(int AutoID)
        {
        ...
        {
            if ((obj == null) || !(obj is systemdomainEntity))
            {
                return false;
            }
            systemdomainEntity tmpObj = (systemdomainEntity)obj;
