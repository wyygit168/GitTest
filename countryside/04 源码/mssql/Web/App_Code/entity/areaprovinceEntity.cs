...
namespace BusinessEntity
{
    ...
    /// <summary>
    /// 实体areaprovinceEntity，对应表areaprovince
    /// </summary>
    [Serializable()]
    public sealed class areaprovinceEntity : EntityObject
    {
        ...
        /// </summary>
        public static areaprovinceEntity GetEntityByPrimaryKey(int AutoID)
        {
        ...
        {
            if ((obj == null) || !(obj is areaprovinceEntity))
            {
                return false;
            }
            areaprovinceEntity tmpObj = (areaprovinceEntity)obj;
