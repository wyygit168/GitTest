...
namespace BusinessEntity
{
    ...
    /// <summary>
    /// 实体systemroleEntity，对应表systemrole
    /// </summary>
    [Serializable()]
    public sealed class systemroleEntity : EntityObject
    {
        ...
        /// </summary>
        public static systemroleEntity GetEntityByPrimaryKey(int AutoID)
        {
        ...
        {
            if ((obj == null) || !(obj is systemroleEntity))
            {
                return false;
            }
            systemroleEntity tmpObj = (systemroleEntity)obj;
