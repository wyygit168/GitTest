...
//             Created Time： 2012/12/31 12:29:18
// -------------------------------------------------------------
namespace BusinessEntity
{
    ...
    /// <summary>
    /// 实体areacityEntity，对应表areacity
    /// </summary>
    [Serializable()]
    public sealed class areacityEntity : EntityObject
    {
        ...
        /// </summary>
        public static areacityEntity GetEntityByPrimaryKey(int AutoID)
        {
        ...
        {
            if ((obj == null) || !(obj is areacityEntity))
            {
                return false;
            }
            areacityEntity tmpObj = (areacityEntity)obj;
