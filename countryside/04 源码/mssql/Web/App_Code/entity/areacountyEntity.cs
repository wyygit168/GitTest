...
namespace BusinessEntity
{
    ...
    /// <summary>
    /// 实体areacountyEntity，对应表areacounty
    /// </summary>
    [Serializable()]
    public sealed class areacountyEntity : EntityObject
    {
        ...
        /// </summary>
        public static areacountyEntity GetEntityByPrimaryKey(int AutoID)
        {
        ...
        {
            if ((obj == null) || !(obj is areacountyEntity))
            {
                return false;
            }
            areacountyEntity tmpObj = (areacountyEntity)obj;
